...
//            FullProjectDto response = projectService.updateStatus(testProject.getId(), ProjectStatus.RELEASED);
//
//            assertNotNull(response, "Response should not be null");
//            assertEquals(ProjectStatus.RELEASED, response.getStatus());
//            assertEquals(testProject.getId(), response.getId());
//            assertTrue(projectRepository.existsById(testProject.getId()), "Project should exist");
//            assertTrue(projectRepository.existsByStatus(ProjectStatus.RELEASED));
//        }
//
//        @Test
