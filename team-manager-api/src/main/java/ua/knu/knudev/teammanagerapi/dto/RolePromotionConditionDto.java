...
@Builder
@Schema(description = "Data transfer object containing role promotion conditions and thresholds")
public record RolePromotionConditionDto(
        @Schema(description = "Unique identifier of the role promotion condition", example = "123e4567-e89b-12d3-a456-426614174000")
        UUID id,
