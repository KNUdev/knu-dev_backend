...
import ua.knu.knudevapp.config.ApplicationConfig;

@SpringBootApplication
@Import({CommonConfig.class, LiquibaseConfig.class, RestConfig.class, ModuleConfig.class, SecurityApiConfig.class,
        TaskManagerConfig.class, TaskManagerApiConfig.class, TeamManagerConfig.class, TeamManagerApiConfig.class, ApplicationConfig.class})
